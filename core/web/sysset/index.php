...
class Index_EweiShopV2Page extends WebPage 
{
	...
	{
		global $_W;
		$path = IA_ROOT . '/addons/hunter_mall/cert';
		load()->func('file');
		mkdirs($path);
	...
	public function payset() 
	{
		...
		$url = $_W['siteroot'] . 'addons/hunter_mall/payment/wechat/notify.php';
	...
	public function templat() 
	{
		...
		$styles = array();
		$dir = IA_ROOT . '/addons/hunter_mall/template/mobile/';
	...
	public function wap() 
	{
		...
		$styles = array();
		$dir = IA_ROOT . '/addons/hunter_mall/template/account/';
		if ($handle = opendir($dir)) 
		{
			while (($file = readdir($handle)) !== false) 
			{
