...
class Finance_EweiShopV2Model 
{
	...
	public function refund($openid, $out_trade_no, $out_refund_no, $totalmoney, $refundmoney = 0, $app = false) 
	{
		global $_W;
		global $_GPC;
		if (empty($openid)) 
	...
	public function refundBorrow($openid, $out_trade_no, $out_refund_no, $totalmoney, $refundmoney = 0, $gaijia = 0) 
	{
		global $_W;
		global $_GPC;
		if (empty($openid)) 
