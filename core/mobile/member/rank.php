...
class Rank_EweiShopV2Page extends MobileLoginPage
{
	...
	protected function creditChange($uid, $credittype = 'credit1', $day = 7)
	{
		...
		$sql = 'select sum(num) from ' . tablename('mc_credits_record') . ' where uniacid = :uniacid and uid = :uid and credittype = :credittype and `module` = "hunter_mall" and createtime between :createtime1 and :createtime2';
