...
require IA_ROOT . '/addons/hunter_mall/core/inc/functions.php';
require IA_ROOT . '/addons/hunter_mall/core/inc/plugin_model.php';
require IA_ROOT . '/addons/hunter_mall/core/inc/com_model.php';
new aliApy();
class aliApy 
{
	public $post;
	...
	public function __construct() 
	{
		...
		$this->total_fee = $this->post['total_fee'];
