...
class Goods_EweiShopV2Page extends PluginWebPage 
{
	...
	public function status() 
	{
		...
		pdo_query('update ' . tablename('ewei_shop_creditshop_goods') . ' set `status` = ' . $status . ' where uniacid=' . $_W['uniacid'] . ' and id in (' . implode(',', $ids) . ')');
		show_json(1);
	}
}
?>