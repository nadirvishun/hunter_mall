...
require hunter_mall_INC . '/plugin_processor.php';
class SnsProcessor extends PluginProcessor
{
	...
	public function respond($obj = NULL)
	{
		...
		if (($msgtype == 'text') || ($event == 'click')) {
			...
			$r_img = tomedia($r_img);
			$news = array(
				array('title' => $r_title, 'picurl' => $r_img, 'description' => $r_desc, 'url' => $_W['siteroot'] . 'app/index.php?i=' . $_W['uniacid'] . '&c=entry&m=hunter_mall&do=mobile&r=sns.board&id=' . $board['id'])
				);
