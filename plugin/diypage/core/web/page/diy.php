...
class Diy_EweiShopV2Page extends PluginWebPage
{
	public function main()
	{
		...
		$result = $this->model->getPageList('diy', $condition, $_GPC['page']);
		extract($result);
	...
	protected function post($do)
	{
		...
		$diymenu = pdo_fetchall('select id, name from ' . tablename('ewei_shop_diypage_menu') . ' where uniacid=:uniacid order by id desc', array(':uniacid' => $_W['uniacid']));
