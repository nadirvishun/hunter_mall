define(['jquery.ui'], function (ui) {
    ...
    modal.getNavs = function () {
        modal.navs = {
            notice: {
                name: '公告',
                params: {
                    'iconurl': '../addons/hunter_mall/plugin/diypage/static/images/default/hotdot.jpg',
                    'noticedata': '0',
                    'speed': '4',
                    'noticenum': '5'
                },
            ...
            banner: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '../addons/hunter_mall/plugin/diypage/static/images/default/banner-1.jpg',
                        linkurl: '',
                    },
                    C0123456789102: {
                        imgurl: '../addons/hunter_mall/plugin/diypage/static/images/default/banner-2.jpg',
                        linkurl: '',
                    }
                }
            },
            ...
            menu: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '../addons/hunter_mall/plugin/diypage/static/images/default/icon-1.png',
                        linkurl: '',
                        text: '按钮文字1',
                        color: '#666666'
                    },
                    C0123456789102: {
                        imgurl: '../addons/hunter_mall/plugin/diypage/static/images/default/icon-2.png',
                        linkurl: '',
                        text: '按钮文字2',
                        color: '#666666'
                    },
                    C0123456789103: {
                        imgurl: '../addons/hunter_mall/plugin/diypage/static/images/default/icon-3.png',
                        linkurl: '',
                        text: '按钮文字3',
                        color: '#666666'
                    },
                    C0123456789104: {
                        imgurl: '../addons/hunter_mall/plugin/diypage/static/images/default/icon-4.png',
                        linkurl: '',
                        text: '按钮文字4',
                        color: '#666666'
                    }
            ...
            goods: {
                ...
                data: {
                    C0123456789101: {
                        thumb: '../addons/hunter_mall/plugin/diypage/static/images/default/goods-1.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
                    ...
                    C0123456789102: {
                        thumb: '../addons/hunter_mall/plugin/diypage/static/images/default/goods-2.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
                    ...
                    C0123456789103: {
                        thumb: '../addons/hunter_mall/plugin/diypage/static/images/default/goods-3.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
                    ...
                    C0123456789104: {
                        thumb: '../addons/hunter_mall/plugin/diypage/static/images/default/goods-4.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
            ...
            detail_shop: {
                ...
                max: 1,
                params: {
                    shoplogo: "../addons/hunter_mall/static/images/designer.jpg",
                    shopname: "",
                    shopdesc: "",
                    hidenum: 0,
                    leftnavtext: "全部商品",
    ...
    modal.initTpl = function () {
        tpl.helper("imgsrc", function (src) {
            ...
            if (src.indexOf('http://') == 0 || src.indexOf('https://') == 0 || src.indexOf('../addons/hunter_mall/') == 0) {
                return src
