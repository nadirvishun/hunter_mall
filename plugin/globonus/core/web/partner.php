...
class Partner_EweiShopV2Page extends PluginWebPage
{
	...
	public function partnerblack()
	{
		...
		foreach ($members as $member ) {
			...
			if ($partnerblack == 1) {
				pdo_update('ewei_shop_member', array('ispartner' => 1, 'partnerstatus' => 0, 'partnerblack' => 1), array('id' => $_GPC['id']));
				...
				pdo_update('ewei_shop_member', array('ispartner' => 1, 'partnerstatus' => 1, 'partnerblack' => 0), array('id' => $_GPC['id']));
