		...
		foreach ($fields as $key => $value ) 
		{
			...
			if ($data_type == 0) 
			{
				...
				if (!empty($data[$key])) 
				{
					...
					{
						case 2: $m_data['realname'] = $mc_data['realname'] = $data[$key];
						break;
						case 3: $m_data['mobile'] = $mc_data['mobile'] = $data[$key];
						break;
						case 4: $m_data['weixin'] = $data[$key];
						break;
					}
				}
			}
				...
				foreach ($fields as $key => $value ) 
				{
					if (!array_key_exists($key, $f_data)) 
					{
						...
						if ($value['data_type'] == 0) 
						{
							switch ($value['tp_is_default']) 
							{
								case 1: $f_data[$key] = $value['tp_default'];
								break;
								case 2: $f_data[$key] = $member['realname'];
								break;
								case 3: $f_data[$key] = $member['mobile'];
								break;
								case 4: $f_data[$key] = $member['weixin'];
								break;
							}
						}
						else if ($value['data_type'] == 7) 
						{
							switch ($value['default_time_type']) 
							{
								case 0: $f_data[$key] = '';
								break;
								case 1: $f_data[$key] = date('Y-m-d');
								break;
								case 2: $f_data[$key] = $value['default_time'];
								break;
							}
						}
						else if ($value['data_type'] == 8) 
						{
							switch ($value['default_btime_type']) 
							{
								case 0: $f_data[$key][0] = '';
								break;
								case 1: $f_data[$key][0] = date('Y-m-d');
								break;
								case 2: $f_data[$key][0] = $value['default_btime'];
								break;
							}
							switch ($value['default_etime_type']) 
							{
								case 0: $f_data[$key][1] = '';
								break;
								case 1: $f_data[$key][1] = date('Y-m-d');
								break;
								case 2: $f_data[$key][1] = $value['default_etime'];
								break;
							}
						}
						else 
