...
class Login_EweiShopV2Page extends Page
{
	public function main()
	{
		...
		if ($_W['ispost']) {
			...
			$url = $_W['siteroot'] . 'web/merchant.php?c=site&a=entry&i=' . $account['uniacid'] . '&m=hunter_mall&do=web&r=shop';
			show_json(1, array('url' => $url));
		}


		$submitUrl = $_W['siteroot'] . 'web/merchant.php?c=site&a=entry&i=' . $_SESSION['__merch_uniacid'] . '&m=hunter_mall&do=web&r=login';
